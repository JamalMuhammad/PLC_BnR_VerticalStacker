# -*- coding: utf-8 -*-
"""
Created on Sat Oct 16 06:57:35 2021
...
if __name__ == "__main__":
    ...
    try:
        ...
        var = client.get_node("ns=6;s=::Program:xUnloadPartCmd")
        ...
        dv = ua.DataValue(ua.Variant([new_varvalue], ua.VariantType.Boolean))
        dv.ServerTimestamp = None
        dv.SourceTimestamp = None        
        #Assigning time stamp gives following error
        ...
        #dv.SourceTimestamp = datetime.datetime.now()      
